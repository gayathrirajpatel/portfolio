...
export const projects = [
  {
    ...
    description:
      "Job Portal for international students is our attempt to address unique challenges international students face when applying jobs.",
    image:
   'https://ibb.co/6gkjNpv',
    tags: [
      "Figma",
      "UX Design",
      "Usability Testing",
